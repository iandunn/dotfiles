...
export SITE_PATH="$HOME/local-sites/10up/harvard/app/public/wp-content"
echo -n -e "\033]0;harvard Shell\007"

export MYSQL_HOME="$HOME/Library/Application Support/Local/run/khX5aUhRW/conf/mysql"
export PHPRC="$HOME/Library/Application Support/Local/run/khX5aUhRW/conf/php"
