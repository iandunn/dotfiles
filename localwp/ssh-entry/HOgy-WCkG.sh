...
export SITE_PATH="$HOME/local-sites/10up/fhl/app/public/wp-content"
echo -n -e "\033]0;fhl Shell\007"

export MYSQL_HOME="$HOME/Library/Application Support/Local/run/HOgy-WCkG/conf/mysql"
export PHPRC="$HOME/Library/Application Support/Local/run/HOgy-WCkG/conf/php"
