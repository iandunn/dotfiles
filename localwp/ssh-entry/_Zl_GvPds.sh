...
export SITE_PATH="$HOME/local-sites/10up/williams/app/public/wp-content"
echo -n -e "\033]0;williams Shell\007"

export MYSQL_HOME="$HOME/Library/Application Support/Local/run/_Zl_GvPds/conf/mysql"
export PHPRC="$HOME/Library/Application Support/Local/run/_Zl_GvPds/conf/php"
...
cd $SITE_PATH/themes/williams-2026
