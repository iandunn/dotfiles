...
export SITE_PATH="$HOME/local-sites/10up/comics/app"
echo -n -e "\033]0;comics kingdom Shell\007"

export MYSQL_HOME="$HOME/Library/Application Support/Local/run/PI403ONHm/conf/mysql"
export PHPRC="$HOME/Library/Application Support/Local/run/PI403ONHm/conf/php"
