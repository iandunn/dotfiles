...
export SITE_PATH="$HOME/local-sites/misc/app/public/"
echo -n -e "\033]0;misc Shell\007"

export MYSQL_HOME="$HOME/Library/Application Support/Local/run/adAGViECs/conf/mysql"
export PHPRC="$HOME/Library/Application Support/Local/run/adAGViECs/conf/php"
